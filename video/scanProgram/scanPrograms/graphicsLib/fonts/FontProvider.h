...
#ifndef PICOTEMPLATE_FONTPROVIDER_H
#define PICOTEMPLATE_FONTPROVIDER_H

#include <cstdint>
namespace video::fonts {

        class FontProvider {

        public:
            constexpr static uint8_t font8x8_basic[128][8] = {
            ...
            static constexpr uint8_t font8x8_ext_latin[96][8] = {
...
#endif //PICOTEMPLATE_FONTPROVIDER_H
